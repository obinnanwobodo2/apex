  ...
  return (
    <section className="py-24 bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-[600px] h-[300px] rounded-full blur-[120px] opacity-15"
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mt-4 mb-5 leading-tight">
            Ready to grow your
            <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/#packages"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-bold text-white transition-all hover:opacity-90"
            ...
            <Link href="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl text-base font-semibold text-gray-900 border border-gray-300 bg-white hover:bg-gray-100 hover:border-gray-400 transition-all">
